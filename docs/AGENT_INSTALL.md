...
> 当前 Stable 是 `v3.0.2`；正式 Asset 为 `enterprise-ai-project-delivery-v3.0.2.zip`，SHA-256 为 `0a8593245200f05ce942bb2a65fe259d36fcc565cbfd29fc9cb0defaa43b8f54`，exact identity 为 `tag v3.0.2 -> commit 0f3ec251a6dadf22a4dd679083b2efd32e0af24b`。`v3.0.1` 是 FAILED POST-RELEASE VALIDATION 历史，不得安装或解析为 Stable。
