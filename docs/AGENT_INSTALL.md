...
> 当前 Stable 是 `v3.0.1`；正式 Asset 为 `enterprise-ai-project-delivery-v3.0.1.zip`，SHA-256 为 `11b253026efd5dac7b7e40ed6bb49d340c153c4ef8113cb6d8dd4a8e9267aa46`，exact identity 为 `tag v3.0.1 -> commit 1d4eb860f175505e2e12f4f56ed54ad64e3f1236`。
